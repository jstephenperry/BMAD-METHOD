...
We recommend always using the latest version of Continuous Agile to ensure you have the most recent security updates.
...
1. **GitHub Security Advisories**: Use [GitHub's private vulnerability reporting](https://github.com/jstephenperry/continuous-agile/security/advisories/new) to submit a confidential report.
...
- Vulnerabilities in Continuous Agile core framework code
...
We appreciate the security research community's efforts in helping keep Continuous Agile secure. Contributors who report valid security issues will be acknowledged in our security advisories.

---

Thank you for helping keep Continuous Agile safe.
