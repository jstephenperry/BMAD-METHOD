...
class OfficialModules {
  ...
  async copyModuleWithFiltering(sourcePath, targetPath, fileTrackingCallback = null, moduleConfig = {}, installOptions = {}) {
    ...
    for (const file of sourceFiles) {
      ...
      // Skip module root config.yaml only - the retired per-module config
      // regime; nothing reads `_bmad/<module>/config.yaml` any more.
...
module.exports = { OfficialModules, parseCentralToml };
