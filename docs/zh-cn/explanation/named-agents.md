---
title: "命名智能体"
description: 为什么 Continuous Agile 的智能体有名字、人设和自定义能力——相比菜单驱动或纯提示驱动的方案，这解锁了哪些可能性
sidebar:
  order: 1
---
...
这一页解释背后发生了什么，以及 Continuous Agile 为什么这样设计。

## 三足鼎立

Continuous Agile 的智能体模型建立在三个可组合的基本要素之上：
...
Continuous Agile 内置五个命名智能体，各自对应交付流程的一个阶段：
...
- [如何自定义 Continuous Agile](../how-to/customize-bmad.md) — 可自定义项和合并规则的参考
- [如何为组织扩展 Continuous Agile](../how-to/expand-bmad-for-your-org.md) — 五个实操方案，覆盖智能体全局规则、工作流约定、外部发布、模板替换和花名册管理
