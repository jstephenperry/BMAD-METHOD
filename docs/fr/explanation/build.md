...
La planification amont reste optionnelle et variable. Un changement clair peut entrer directement ; une initiative plus vaste peut apporter PRD, UX, architecture, epics, stories et contrôle de préparation. Ces artefacts renforcent le contexte sans sélectionner un autre workflow de développement.
