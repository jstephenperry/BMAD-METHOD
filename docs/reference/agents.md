...
This page lists the default BMM (Agile suite) agents that install with Continuous Agile, along with their skill IDs, menu triggers, and primary workflows. Each agent is invoked as a skill.
