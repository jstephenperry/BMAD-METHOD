---
title: "Workflow Map"
description: Visual reference for Continuous Agile workflow phases and outputs
sidebar:
  order: 1
---

The Agile suite (BMM) is one of the Continuous Agile modules, targeted at following the best practices of context engineering
...
installed Continuous Agile. Additionally, if you are using different modules that have extended it or added
